...
public class ImageUtil {
  ...
  /**
   * Method to get a BufferedImage object based on the pixels, width and height of an Image.
   *
   * @param pixels 3D array of integers, representing the image.
   * @param width Integer, width of the image in pixels.
   * @param height Integer, height of the image in pixels/
   * @return BufferedImage, the BufferedImage generated using the given data.
   */
  public static BufferedImage getBufferedImage(int[][][] pixels, int width, int height) {
